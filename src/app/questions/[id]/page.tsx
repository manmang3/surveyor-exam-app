  ...
  const findNextQuestion = useCallback((currentQuestion: Question): Question | null => {
    ...
    const detailCategoryOrderBySubcategory = {
      ...
      "総則": {
        ...
        "代理": 5, "無権代理と相続": 6, "無効と取り消し": 7, "条件": 8, "取得時効": 9,
        "時効の援用": 10, "時効の更新": 11, "不動産": 12,
      },
      "物権": {
        "物件変動": 0, "不動産の物権変動": 1, "取得時効と登記": 2, "取得時効": 3, "相続と登記": 4,
        "物件的請求権": 5, "占有権": 6, "占有訴権": 7, "袋地所有者の囲繞地通行権": 8, "囲繞地通行権": 9,
        "相隣関係": 10, "共有": 11, "地上権": 12, "質権": 13, "付合": 14,
      },
      "相続": {
