...
export const sampleQuestions: Question[] = [
  ...
  },
  {
    ...
    "questionNumber": 20,
    "title": "問題20",
    "content": "土地家屋調査士の欠格事由に関する次のアからオまでの記述のうち、令和5年4月1日現在において誤っているものは幾つあるか。ただし、自然人A、B、C、D及びEはいずれも令和4年度土地家屋調査士試験に合格しており、また、各人について選択肢に記載されている以外の事由は一切考慮しないものとする。\n\nア　平成16年10月1日生まれの未婚のAは、土地家屋調査士となる資格を有しない。\n\nイ　令和元年5月1日に懲戒処分により司法書士の業務を禁止されたBは、土地家屋調査士となる資格を有しない。\n\nウ　令和2年5月1日に破産手続開始の決定を受けたCは、令和4年12月1日に復権の決定が確定しても、土地家屋調査士となる資格を有しない。\n\nエ　令和3年10月1日に懲戒処分により公認会計士の登録を抹消されたDは、土地家屋調査士となる資格を有しない。\n\nオ　X県の職員として令和4年4月1日に減給6か月の懲戒処分を受け、同年12月1日付けで同県を退職したEは、土地家屋調査士となる資格を有しない。",
    "options": [
      "1個",
      "2個",
      "3個",
  ...
  },
  {
    ...
    "questionNumber": 1,
    "title": "問題1",
    "content": "詐欺又は強迫による意思表示に関する次のアからオまでの記述のうち，判例の趣旨に照らし正しいものの組合せは，後記１から５までのうち，どれか。\n\nア　Ａの代理人Ｂが相手方Ｃを欺罔して，Ｃが所有する土地をＡに売り渡す旨の売買契約を締結させた場合には，ＡがＢによる詐欺の事実について善意かつ無過失であっても，Ｃは，詐欺を理由としてその意思表示を取り消すことができる。\nイ　ＡがＢに欺罔された結果，法律行為の要素に錯誤を生じて意思表示をした場合には，Ａは，詐欺による意思表示の取消しを主張することはできるが，錯誤による意思表示の取消しを主張することはできない。\nウ　ＡのＢに対する意思表示が第三者Ｃの強迫によりされた場合には，Ｂがその事実を知らないときであっても，Ａは，強迫を理由としてその意思表示を取り消すことができる。\nエ　ＡがＢの強迫によりその所有する土地をＢに売却し，ＡからＢへの所有権の移転の登記がされた場合において，その後，ＢがＣに当該土地を転売した後に，Ａが強迫を理由としてＡＢ間の売買の意思表示を取り消したときは，Ａは，Ｂへの所有権の移転の登記を抹消しない限り，Ｃに対して所有権を主張することができない。\nオ　Ａが，Ｂの詐欺により，Ｂからその所有する土地を買い受け，ＢからＡへの所有権の移転の登記がされた後，Ａが，Ｂに欺罔されていることを知らないまま，当該土地にＣを抵当権者とする抵当権を設定し，その旨の登記がされた場合において，Ｃが当該抵当権の設定時にＢによる詐欺の事実について善意かつ無過失であったときは，Ａは，詐欺を理由としてＡＢ間の売買の意思表示を取り消すことができない。",
    "options": [
      "アウ",
      "アオ",
      "イウ",
  ...
  },
  {
    ...
    "questionNumber": 1,
    "title": "問題1",
    "content": "AがBに対して100万円を貸し付けた後その返還期日を経過した事例に関する次のアからオまでの記述のうち，判例の趣旨に照らし誤っているものの組合せは，後記１から５までのうち，どれか。\n\nア　ＡがＢに対して，貸金の返還の催告をした後，その６か月以内に再び催告をしたときは，その時から６か月を経過するまでの間は，時効は，完成しない。\nイ　ＡのＢに対する貸金返還請求を認容する判決が確定したときは，裁判上の請求によって完成が猶予された時効は，当該判決が確定した時から，新たにその進行を始める。\nウ　ＡがＢに対して貸金返還請求の訴えを提起した場合には，その訴訟手続におけるＡの権利行使の意思の表示は，その訴えが取り下げられたときにおいても，Ｂに対する催告としての効力を有するため、訴えの取下げの時から6ヶ月を経過するまでの間は、時効は、完成しない。\nエ　時効の完成前にＢがＡに対して債務の一部弁済として50万円を支払ったときは，当該債務の残部について時効の完成が更新されない。\nオ　時効の完成後にＢがＡに対して債務の承認をしたときは，Ｂは，その後その時効の援用をすることができない。",
    "options": [
      "アウ",
      "アエ",
      "イウ",
